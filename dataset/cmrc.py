...
from bert_text.dataset.dataset import SquadExample
from bert import tokenization
from bert_text.prepare.reading_comprehension import customize_tokenizer
...
class CMRC():
    ...
    def print_info(self, print_num = 1):
        ...
        for e in self.get_train_examples()[:print_num]:
            print("{}\t{}\t{}\t{}\t{}\t{}".format(e.qas_id, e.question_text, e.doc_tokens, e.orig_answer_text, e.start_position, e.end_position))
        print("\n")

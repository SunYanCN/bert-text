...
import pandas as pd
from bert_text.utils.evaluate_utils import Evaluate_helper
...
class BatchGenerator(object):
    ...
    def next_batch(self, batch_size):
        ...
        batch_inputs = [self._unique_ids[start:end], self._input_ids[start:end], self._input_masks[start:end],self._segment_ids[start:end]]
